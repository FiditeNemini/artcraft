...
import { toggleLipSyncMute } from "~/pages/PageEnigma/store";
import { 
  faVolume,
  faVolumeSlash
...
export const LipSyncSubHeader = ({
  ...
  if (editorEngine && editorEngine.isObjectLipsync(character.object_uuid)){
    return(
      <div className="flex mb-3 h-[36px] flex-col justify-center pl-[22px] text-xs font-medium text-white opacity-80">
