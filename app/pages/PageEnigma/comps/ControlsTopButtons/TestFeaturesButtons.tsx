  ...
  return(
    <>
      <div className="flex gap-1">
        <Button variant="secondary" onClick={handleButtonCameraView} className={smallButtons}>
          Toggle Camera View
        </Button>
        <Button
          onClick={testObjectPanel}
          className={smallButtons}
        >
          Object Panel
        </Button>
        <Button
          onClick={testTTSPanel}
          className={tertiaryColor + smallButtons}
        >
          TTS Panel
        </Button>
      </div>
      <div className="flex gap-1">
        <Button onClick={handleButtonSingleFrame} className={smallButtons}>Render Single Frame</Button>
        <Button onClick={handleButtonTakeFrame} className={smallButtons}>Take Frame</Button>
        <Button onClick={handleButtonRender} className={smallButtons}>Render</Button>
        <Button
          onClick={testStylizeRequest}
          className={"bg-brand-tertiary hover:bg-brand-teriary-400 focus-visible:outline-brand-tertiary " +smallButtons}
          style={{ zIndex: 9001 }}
        >
          Test Stylize
        </Button>
