...
export const Slider: React.FC<SliderProps> = ({
  ...
  return (
    ...
    >
      <div
        className="absolute h-2.5 rounded-full bg-brand-primary"
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        {showTooltip && showHandleTooltip && (
          <div
            className="absolute -top-8 z-10 rounded-md bg-ui-controls px-2 py-1 text-xs text-white shadow-lg"
