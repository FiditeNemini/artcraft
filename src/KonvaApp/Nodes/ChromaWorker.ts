...
self.onconnect = (event: MessageEvent) => {
    ...
    port.onmessage = (event: MessageEvent) => {
        ...
        const offscreenCanvas = new OffscreenCanvas(dataTransfer.width, dataTransfer.height);
        ...
        const imageData = ctx.getImageData(0, 0, dataTransfer.width, dataTransfer.height);
        ...
        if (green > chromaColor["green"] && red < chromaColor["red"] && blue < chromaColor["blue"]) {
