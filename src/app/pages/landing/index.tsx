...
const Landing = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Transform your composition with AI style transfer magic. Choose from our curated collection of artistic styles - from classic art to modern aesthetics. Apply consistent styling across your entire scene to create a cohesive visual masterpiece.",
      image: "",
      gradient: "bg-gradient-to-br from-rose-500/20 to-orange-500/20",
    },
    {
      title: "Final Step: Render Your Movie",
      description:
        "Watch your story come to life as we render your styled composition into a stunning final movie. Export in high quality, ready to share with the world. From concept to final cut - create professional-looking videos in minutes, not hours.",
      image: "",
