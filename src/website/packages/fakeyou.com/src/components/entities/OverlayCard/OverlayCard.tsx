...
export default function OverlayCard({ data, makeRatingsProps, preview: Preview, showCreator }: Props) {
  ...
  return <>
    ...
    <div {...{ className: "card-img-overlay" }}>
      ...
      <CardBadge {...{ className: `fy-entity-type${ data.media_type ? "-" + data.media_type : "" }`, label: data.media_type }}/>
    </div>
