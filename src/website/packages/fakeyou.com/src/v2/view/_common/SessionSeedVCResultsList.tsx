...
function SessionSeedVCResultsList() {
  ...
  inferenceJobsByCategory
    .get(FrontendInferenceJobType.SeedVc)
    .forEach((job: InferenceJob, index: number, array: InferenceJob[]) => {
            ...
            <div>
              <div className="panel panel-results p-3 gap-3 d-flex flex-column">
                <div>
                  ...
                  <p className="mb-0 fs-7 pt-1">{job.maybeRawInferenceText}</p>
                </div>
...
export { SessionSeedVCResultsList };
