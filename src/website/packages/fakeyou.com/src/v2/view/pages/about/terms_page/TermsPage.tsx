        ...
        <div className="row gx-3 flex-lg-row-reverse align-items-center">
          ...
          <div className="col-lg-6 px-md-2 ps-lg-5 ps-xl-2">
            <div className="text-center text-lg-start">
              <div>
                <h1 className=" fw-bold lh-1 mb-3">Terms and Conditions</h1>
              </div>
              <div>
                <p className="lead">
        ...
        <div className="panel p-3 p-lg-4 load-hidden mt-5 mt-lg-0">
          ...
          <div className="py-6 d-flex flex-column gap-4">
            ...
            <p>
              ...
              Terms of Use, including the User Agreement posted on the Site,
              which are incorporated into these Terms of Use. IF YOU DO NOT
            ...
            <p>
              ...
              except in accordance with the EULA or these Terms of Use.
            </p>
            ...
            <ul>
              ...
              <li>
                Use the website to impersonate other people without labeling the
                outputs as parody
              </li>
            ...
            <p>
              ...
              law, the arbitration will take place in Cobb, Georgia. Except as
            ...
            <p>
              ...
              state and federal courts located in Cobb, Georgia, and the Parties
