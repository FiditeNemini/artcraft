        ...
        <Container type="panel" className="mb-5">
          ...
          <Panel padding={true} mb={true}>
            <h2 className="mt-3 mb-3 fw-bold">
              You don't have access to Storyteller Studio yet.
            </h2>
            <p>
              If you have a beta invite key,{" "}
              <Link to="/beta-key/redeem">enter it here</Link>.
            </p>
          </Panel>
        </Container>
      </>
  ...
  return (
    <Container type="panel" className="mb-5">
      ...
      <Panel padding={true} mb={true}>
        ...
        <p>
          In a short amount of time, we'll be rolling the studio out to more
          people. Check <Link to="/beta-key/list">this page</Link> to see when
          you've got beta invites to hand out to your friends.
        </p>
      </Panel>
    </Container>
  );
