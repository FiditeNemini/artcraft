...
fn main() -> AnyhowResult<()> {
  ...
  let program_args = ProgramArgs {
    tweet_text: "This is a deepfake response generated by vo.codes. Use responsibly.".to_string(),
    temp_directory: "/tmp".to_string(),
    png_filename: "/home/bt/dev/voice/twitter-vocodes-bot/assets/sonic-full.png".to_string(),
    core_thread_count: 10,
    queue_length: 10,
    worker_count: 5,
  };
