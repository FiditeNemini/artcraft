    ...
    return (
      <div className="content is-medium">
            ...
            <div className="columns is-vcentered">
              ...
              <div className="column">
                ...
                <p className="subtitle">
                  We're building <strong>FakeYou</strong> as just one component
                  of a broad set of production and creative tooling.
                </p>
              </div>
            </div>
          </div>
        ...
        <p>
          ...
          out. They're impressive, maybe a little bit scary, but they're about
          to become the new norm. People will become accustomed to the
          technology, and the results will be used mostly for creative good,
          unlocking previously costly and unattainable high production values
          for individual creators. It's our belief that the next Hollywood will
          be <em>you</em>.
        </p>

        <p>
          The technology to clone voices is already out in the open, and the
          voices here are built by a community of contributors. We're not the
          only website doing this, and plenty of people are producing these same
        ...
        <p>
          As an interesting point, most if not all of the voices produced by
          this website are actually
        ...
        <p>
          ...
          but has been rebranded to better reflect its purpose and direction.
          (Not many people know what a <em>vocoder</em> is anyway, so it didn't
          make sense to keep the name.)
        </p>
        ...
        <p>
          ...
          with data gathering and annotation, Discord moderation, ML advice,
          etc.
        </p>

        <p>
          Vegito1089, Shin, Ashurath, MakaveliGH, Blutarch Mann, Yahia, Tim
          Squid, Seuneramet, Matt, Seth, CookiePPP,
          <a
