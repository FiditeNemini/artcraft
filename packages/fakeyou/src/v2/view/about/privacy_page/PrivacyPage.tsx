...
In simple terms, we basically run a web service that allows you to register, submit data, upload voice data, and share results with others. 
We run Google Analytics and collect payment information. 
We do not analyze your audio in an attempt to identify it, sell it, or use it in any way other than to provide and improve our service.
But here's the legalese:

{/* From https://app.termly.io/document/privacy-policy/772c10f5-4a8b-401e-b00a-c3cba9760652 */}

<h1>Privacy Statement</h1>

<p>This privacy notice for Learning Machines, Inc (doing business as Storyteller) ("Storyteller," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:</p>

  <ul>
    <li>Visit our website at https://fakeyou.com, or any website of ours that links to this privacy notice</li>

    <li>Download and use our mobile application (FakeYou), or any other application of ours that links to this privacy notice</li>

    <li>Engage with us in other related ways, including any sales, marketing, or events</li>
  </ul>

<p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <code>support@storyteller.io</code>.</p>


<h3>SUMMARY OF KEY POINTS</h3>

<p><strong>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for. {/*You can also click here to go directly to our table of contents.*/}</strong></p>

<p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Storyteller and the Services, the choices you make, and the products and features you use. {/*Click here to learn more.*/}</p>
...
<p><strong>In what situations and with which types of parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties. {/*Click here to learn more.*/}</p>
...
{/*<p>Want to learn more about what Storyteller does with any information we collect? Click here to review the notice in full.</p>*/}
...
<p>Payment Data. We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Stripe. You may find their privacy notice link(s) here: <code>https://stripe.com/privacy</code>.</p>
...
<p>Application Data. If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:</p>
    ...
    <ul><li>Mobile Device Data. We automatically collect device information (such as your mobile device ID, model, and manufacturer), operating system, version information and system configuration information, device and application identification numbers, browser type and version, hardware model Internet service provider and/or mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using our application(s), we may also collect information about the phone network associated with your mobile device, your mobile device’s operating system or platform, the type of mobile device you use, your mobile device’s unique device ID, and information about the features of our application(s) you accessed.</li></ul>
...
<ul>
    <li><strong>Consent.</strong> We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. {/*Click here to learn more.*/}</li>
...
<p>If you have questions or comments about your privacy rights, you may email us at <code>support@storyteller.io</code>.</p>
...
{/* TODO: REMOVE BULLET POINT STYLE */}
<ol>
...
<p>You may contact us by email at <code>support@storyteller.io</code>, or by referring to the contact details at the bottom of this document.</p>
...
<p>Learning Machines, Inc has not sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Learning Machines, Inc has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
...
<p>To exercise these rights, you can contact us by email at <code>support@storyteller.io</code>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
...
<p>If you have questions or comments about this notice, you may email us at <code>support@storyteller.io</code></p>


<h3>15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>

<p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please {/*submit a request form by clicking here*/} contact us at <code>support@storyteller.io</code>.</p>
