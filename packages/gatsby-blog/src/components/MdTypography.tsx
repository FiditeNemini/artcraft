...
>) => (
  <p className={twMerge("text-md", className)} {...rest} >
    {children}
  </p>
);

export const H1 = ({ children, className, ...rest }: HeadingProps) => (
  <h1 className={twMerge("text-3xl md:text-5xl font-bold", className)} {...rest}>
    {children}
  </h1>
);

export const H2 = ({ children, className, ...rest }: HeadingProps) => (
  <h2 className={twMerge("text-xl md:text-2xl font-bold", className)} {...rest}>
    {children}
  </h2>
);
...
export const H3 = ({ children, className, ...rest }: HeadingProps) => (
  <h3 className={twMerge("text-xl font-bold", className)} {...rest}>
    {children}
  </h3>
);
