...
import FaceAnimationUploadComponent from "./FaceAnimationUploadComponent";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faBarsStaggered } from "@fortawesome/free-solid-svg-icons";
import { FaceAnimationPageResultList } from "./FaceAnimationPageResultList";
...
function FaceAnimationPage(props: Props) {
  PosthogClient.recordPageview();
  usePrefixedDocumentTitle("Face Animation");
  ...
  return (
    <div>
      <div className="container-panel pt-4 pb-5">
        <h1>Face Animation (Alpha)</h1>

        <br />
        <br />

        <h2>Audio</h2>
        <FaceAnimationUploadComponent
