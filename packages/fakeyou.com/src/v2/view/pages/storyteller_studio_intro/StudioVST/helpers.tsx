...
export function isInputValid(keyValues: {
...
export function mapRequest(vstValues: VSTType) {
  ...
  return {
    ...
    maybe_trim_start_seconds: 0, //vstValues.trimStart
    maybe_trim_end_seconds: 3, //vstValues.trimEnd
    ...
    maybe_json_modifications: {
      ...
      "$.510.inputs.Text": hiddenValues.posPrompt + vstValues.posPrompt,
      "$.8.inputs.text": hiddenValues.negPrompt + vstValues.negPrompt,
