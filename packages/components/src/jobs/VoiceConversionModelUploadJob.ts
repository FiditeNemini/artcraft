...
export class VoiceConversionModelUploadJob {
  jobToken: string;
  ...
  static fromResponse(response: RemoteDownloadJobStatus) :  VoiceConversionModelUploadJob {
    return new VoiceConversionModelUploadJob(
      response.job_token,
      response.status,
...
export interface VoiceConversionModelUploadJobStateResponsePayload {
  success: boolean,
  state?: VoiceConversionModelUploadJobState,
}

export interface VoiceConversionModelUploadJobState {
  job_token: string,
  status: string,
