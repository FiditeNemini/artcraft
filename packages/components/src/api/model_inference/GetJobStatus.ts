...
export const GetJobStatus = MakeRequest<string,GetJobStatusRequest,GetJobStatusResponse,{}>({
  method: "GET",
  routingFunction: (jobToken: string) =>`/v1/model_inference/job_status/${jobToken}`,
});
