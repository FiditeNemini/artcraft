...
CREATE TABLE media_files (
  ...
  -- If this media file was generated by something upstream (eg. style transfer has an original video),
  -- this encodes the upstream reason.
  maybe_upstream_media_file_type VARCHAR(32) DEFAULT NULL,

  -- If this media file was generated by something upstream (eg. style transfer has an original video),
  -- this is a link to that file.
  maybe_upstream_media_file_token VARCHAR(32) DEFAULT NULL,
