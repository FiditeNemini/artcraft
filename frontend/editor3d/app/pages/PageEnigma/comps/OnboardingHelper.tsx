...
export const OnboardingHelper = () => {
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <div className="glass pointer-events-none absolute left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 transform items-center justify-center gap-2 rounded-2xl border-2 border-brand-primary !bg-brand-primary/10 px-5 py-4">
