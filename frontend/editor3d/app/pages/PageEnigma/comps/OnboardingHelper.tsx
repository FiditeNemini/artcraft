...
export const OnboardingHelper = () => {
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <div className="glass pointer-events-none absolute bottom-52 left-1/2 z-10 flex -translate-x-1/2  transform items-center justify-center gap-2 rounded-2xl border-2 border-brand-primary !bg-brand-primary/10 px-5 py-4">
