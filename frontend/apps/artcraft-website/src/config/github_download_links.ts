...
export const DOWNLOAD_LINKS = {
  ...
  WINDOWS: 'https://github.com/storytold/artcraft/releases/download/artcraft-v0.7.0/ArtCraft_0.11.0_x64-setup.exe', // 2026-03-02 Credits accounting
  ...
  MACOS: 'https://github.com/storytold/artcraft/releases/download/artcraft-v0.7.0/ArtCraft_0.11.0_universal.dmg', // 2026-03-02 Credits accounting
} as const;
