...
pub async fn ingest_url_scrape_and_save(url: &str, web_content_type: WebContentType, save_directory: &SaveDirectory) -> AnyhowResult<Option<WebScrapingResult>>
{
  let scraping_result = match web_content_type {
    ...
    _ => return Ok(None), // TODO: Implement the rest
  };
