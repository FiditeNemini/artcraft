...
CREATE TABLE news_story_productions (
  ...
  maybe_summary_news_title TEXT,

  -- Comma-separated categories for the story. Generated by LLM.
  maybe_summary_categories TEXT,
  ...
  -- Summarizing the title with LLM/GPT
  -- "not_ready", "ready_waiting", "processing", "retryably_failed", "permanently_failed", "skipped", "done"
  llm_title_summary_status TEXT DEFAULT "not_ready" NOT NULL,

  -- Number of LLM/GPT title summary attempts that have been made
  llm_title_summary_attempts INT DEFAULT 0 NOT NULL,

  -- Classifying the categories with LLM/GPT
  -- "not_ready", "ready_waiting", "processing", "retryably_failed", "permanently_failed", "skipped", "done"
  llm_category_summary_status TEXT DEFAULT "not_ready" NOT NULL,

  -- Number of LLM/GPT category summary attempts that have been made
  llm_category_summary_attempts INT DEFAULT 0 NOT NULL,
