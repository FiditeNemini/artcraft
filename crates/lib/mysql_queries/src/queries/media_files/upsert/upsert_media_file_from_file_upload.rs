...
pub struct UpsertMediaFileFromUploadArgs<'a> {
...
pub async fn upsert_media_file_from_file_upload(
  args: UpsertMediaFileFromUploadArgs<'_>
) -> AnyhowResult<(MediaFileToken, u64)>
{
  let token = args.maybe_media_file_token
