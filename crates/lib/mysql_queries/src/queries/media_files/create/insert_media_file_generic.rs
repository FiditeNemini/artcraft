...
use tokens::tokens::weight_model_weight;
...
pub struct InsertArgs<'a> {
    ...
    pub media_file_origin: MediaFileOriginProductCategory,
    pub media_file_origin_product_category: MediaFileOriginProductCategory,
    pub media_file_origin_model_type: Mediafile,
    pub maybe_origin_filename: String,
    pub maybe_origin_model_token:WeightsModelToken
}
...
) -> AnyhowResult<(MediaFileToken, u64)>
{
    ...
    // TODO: Ask if it make sense to use ONE function to do the insert * I agree it does .... use insert media file generic and eventually remove all this.
