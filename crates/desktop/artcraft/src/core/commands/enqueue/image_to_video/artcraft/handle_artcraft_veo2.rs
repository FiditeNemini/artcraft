...
use artcraft_client::endpoints::generate::video::generate_veo_3_image_to_video::generate_veo_3_image_to_video;
...
pub (super) async fn handle_artcraft_veo2(
  ...
  let aspect_ratio = match request.sora_orientation {
    Some(SoraOrientation::Portrait) => GenerateVeo2AspectRatio::TallNineSixteen,
    Some(SoraOrientation::Landscape) => GenerateVeo2AspectRatio::WideSixteenNine,
    None => GenerateVeo2AspectRatio::WideSixteenNine,
  };
  ...
  Ok(TaskEnqueueSuccess {
    ...
    model: Some(GenerationModel::Veo2),
