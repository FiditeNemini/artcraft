...
use artcraft_api_defs::generate::video::generate_kling_2_1_master_image_to_video::{GenerateKling21MasterAspectRatio, GenerateKling21MasterDuration, GenerateKling21MasterImageToVideoRequest};
...
pub (super) async fn handle_artcraft_kling_2p1_master(
  ...
  let aspect_ratio = match request.sora_orientation {
    Some(SoraOrientation::Portrait) => GenerateKling21MasterAspectRatio::TallNineSixteen,
    Some(SoraOrientation::Landscape) => GenerateKling21MasterAspectRatio::WideSixteenNine,
    None => GenerateKling21MasterAspectRatio::WideSixteenNine,
  };
  ...
  let request = GenerateKling21MasterImageToVideoRequest {
    ...
    duration: Some(GenerateKling21MasterDuration::TenSeconds), // TODO: Parameterize
  };
  ...
  Ok(TaskEnqueueSuccess {
    ...
    model: Some(GenerationModel::Kling21Master),
