...
pub mod tests {
  ...
  fn test_gravatar() {
    // Email 1
    assert_eq!(email_to_gravatar("example@example.com"), "23463b99b62a72f26ed677cc556c44e8".to_string());
    assert_eq!(email_to_gravatar("EXAMPLE@EXAMPLE.COM"), "23463b99b62a72f26ed677cc556c44e8".to_string());
    assert_eq!(email_to_gravatar("  example@example.com \n "), "23463b99b62a72f26ed677cc556c44e8".to_string());

    // Email 2
    assert_eq!(email_to_gravatar("echelon@gmail.com"), "37e7e18f19d8f654a1ace405c846a9de".to_string());
    assert_eq!(email_to_gravatar("ECHELON@GMAIL.COM"), "37e7e18f19d8f654a1ace405c846a9de".to_string());
    assert_eq!(email_to_gravatar("  ECHELON@GMAIL.COM  "), "37e7e18f19d8f654a1ace405c846a9de".to_string());

    // Misc
    assert_eq!(email_to_gravatar(""), "d41d8cd98f00b204e9800998ecf8427e".to_string());
    assert_eq!(email_to_gravatar("   "), "d41d8cd98f00b204e9800998ecf8427e".to_string());
  }
}