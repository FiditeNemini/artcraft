    ...
    let categories = internal_results
        ...
        .map(|c| {
          AssignedCategory {
            ...
            category_creator_user_token: c.category_creator_user_token.clone(),
            category_creator_username: c.category_creator_username.clone(),
            category_creator_display_name: c.category_creator_display_name.clone(),
            category_creator_gravatar_hash: c.category_creator_gravatar_hash.clone(),
            ...
            category_assignment_deleted_at: c.category_assignment_deleted_at.clone(),
          }
        })
