...
use mysql_queries::queries::media_files::create::specialized_insert::insert_media_file_from_studio_gen2::{insert_media_file_from_studio_gen2, InsertArgs};
...
pub struct SaveResultsArgs<'a> {
  ...
  pub gen2_deps: &'a StudioGen2Dependencies,
...
pub async fn validate_and_save_results(args: SaveResultsArgs<'_>) -> Result<MediaFileToken, ProcessSingleJobError> {
  ...
  let (media_file_token, id) = insert_media_file_from_studio_gen2(InsertArgs{
    ...
    maybe_title: Some("untitled video"),
    // TODO: scene and source
    maybe_style_transfer_source_media_file_token: None,
