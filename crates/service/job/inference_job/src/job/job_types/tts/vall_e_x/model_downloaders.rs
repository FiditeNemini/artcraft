...
crate::impl_model_downloader!(
    ...
    "/dependencies/zero_shot_tts/vall-e-x_1.0/whisper-medium/model.safetensors",
    "WHISPER_MEDIUM_TENSOR_FILESYSTEM_PATH",
    "/tmp/downloads/zero_shot_tts/vall-e-x_1.0/whisper-medium/model.safetensors"
);
...
impl VallEXDownloaders {
    ...
    pub fn all_downloaders(&self) -> Vec<&dyn ModelDownloader> {
        vec![&self.vall_e_x, &self.whisper_lg, &self.whisper_md, &self.vocos_encodec_24khz]
    }
}
