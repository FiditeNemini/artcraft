...
const STORYTELLER_CDN_STR: &str = "https://cdn.fakeyou.com";
...
mod tests {
  ...
  mod rooted_path {
    ...
    #[test]
    fn wav_file() {
      let links = MediaLinks::from_rooted_path(MediaDomain::FakeYou, "/foo/bar.wav");
    ...
    #[test]
    fn glb_file() {
      let links = MediaLinks::from_rooted_path(MediaDomain::FakeYou, "/foo/bar.glb");
    ...
    #[test]
    fn jpg_image() {
      let links = MediaLinks::from_rooted_path(MediaDomain::FakeYou, "/foo/bar.jpg");
      assert_eq!(links.cdn_url.as_str(), "https://cdn.fakeyou.com/foo/bar.jpg");
      assert_eq!(links.maybe_thumbnail_template, Some("https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/foo/bar.jpg".to_string()));
      assert_eq!(links.maybe_video_previews, None);
    }

    #[test]
    fn mp4_video() {
      let links = MediaLinks::from_rooted_path(MediaDomain::FakeYou, "/foo/bar.mp4");
      ...
      assert_eq!(video_previews.animated_thumbnail_template, "https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/foo/bar.mp4-thumb.gif");
      assert_eq!(video_previews.still_thumbnail_template, "https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/foo/bar.mp4-thumb.jpg");
    }
  }
  ...
  mod media_path {
    ...
    fn wav_file() {
      ...
      let links = MediaLinks::from_media_path(MediaDomain::FakeYou, &media_path);
    ...
    fn png_image() {
      ...
      assert_eq!(links.maybe_thumbnail_template, Some("https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/media/3/7/m/b/3/37mb3gh8fmj85y21thvbv08bzv24atjt/upload_37mb3gh8fmj85y21thvbv08bzv24atjt.png".to_string()));
      assert_eq!(links.maybe_video_previews, None);
    }
    ...
    fn mp4_video() {
      ...
      assert_eq!(video_previews.animated_thumbnail_template, "https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/media/t/6/c/n/y/t6cnyw4g3e8k7carkk2bvrt6nd3fycjv/storyteller_t6cnyw4g3e8k7carkk2bvrt6nd3fycjv.mp4-thumb.gif");
      assert_eq!(video_previews.still_thumbnail_template, "https://cdn.fakeyou.com/cdn-cgi/image/width={WIDTH},quality={QUALITY}/media/t/6/c/n/y/t6cnyw4g3e8k7carkk2bvrt6nd3fycjv/storyteller_t6cnyw4g3e8k7carkk2bvrt6nd3fycjv.mp4-thumb.jpg");
    }
  }
}
